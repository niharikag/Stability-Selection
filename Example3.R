...
s0 = c(1:15,31:35) #true active set
seq1 = seq(.1,2,.1)

true.beta <- rep(0,p)
true.beta[s0] = sample(seq1,20, replace=FALSE)    
s0Comp = which(true.beta==0) #noise feature index

varMat = matrix(.9,30,30)
varMat = varMat+diag(.1,30)
#create block diagonal matrix
blockMat = superMatrix(list(varMat,diag(70)))
